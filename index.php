          ...
          <div class="row">
            <div class="col-lg-4">
              ...
              <ul class="list-unstyled mb-0">
                ...
                <li><a href="#" class="text-body-secondary">Features</a></li>
                <li><a href="#" class="text-body-secondary">Pricing</a></li>
                <li><a href="#" class="text-body-secondary">FAQs</a></li>
                <li><a href="#" class="text-body-secondary">About</a></li>
              </ul>
            </div>
            <div class="col-lg-4">
